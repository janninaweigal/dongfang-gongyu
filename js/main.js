$(function () {
    ...
    //导航条
    $(".yangsheng").hover(function(){
    	$(this).next(".dropdown-menu").css("display","block");
    	$(".jujia").next(".dropdown-menu").css("display","none");
    });
    $(".jujia").hover(function(){
    	$(this).next(".dropdown-menu").css("display","block");
    	$(".yangsheng").next(".dropdown-menu").css("display","none");
    });
    $(".liaoyang").click(function(){
  	  	$(this).next(".dropdown-menu").find("ul.dropdown-menu").css("display","none");
    });
});